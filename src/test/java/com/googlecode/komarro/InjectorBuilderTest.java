...
import com.googlecode.komarro.Injector;
import com.googlecode.komarro.Injector.InjectorBuilder;
...
public class InjectorBuilderTest {
	...
	@Test
	public void guessInjectionAnnotation() throws SecurityException,
		...
		// then
		assertThat(createdInjector.injectionEngine).isNotNull().isInstanceOf(
				InjectionEngine.class);
		assertThat(createdInjector.injectionPoint).isNotNull().isInstanceOf(
				AnnotatedInjectionPoint.class);
		assertThat(
				createdInjector.injectionPoint
						.isInjectable(InjectorBuilderTest.class
	...
	public void failWhenTryingToGuessInjectionAnnotationButNoAnnotationIsPresent()
	 ...
	 */
	private void setPopularAnnotationNamesToFakeOnes(
